...
import 'package:calculadora_get_ex/widgets/calc_button.dart';
import 'package:calculadora_get_ex/widgets/math_result.dart';
            ...
            Row(
              ...
              children: [
                ...
                CalculatorButton(
                  text: '+/-',
                  bgColor: Color(0xffA5A5A5),
                  onPressed: () => calculatorCtrl.changeNegativeToPositive(),
                ),
                CalculatorButton(
                  text: 'del',
                  bgColor: Color(0xffA5A5A5),
